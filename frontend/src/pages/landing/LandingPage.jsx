      ...
      <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-24 px-6">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Discover unforgettable experiences. Book tickets seamlessly. Create
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 leading-relaxed">
            DEMS is Ethiopia's most trusted event ticketing platform, bringing
            together event organizers and attendees in a seamless, secure, and
            culturally-rich experience. From concerts and conferences to
            workshops and festivals, we make discovering and attending events
            effortless.
          </p>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Browse featured, trending, and nearby events
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Save your tickets and complete checkout within 15 minutes
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Access your tickets with QR codes instantly
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Register as an organizer and get verified
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Add details, tickets, and manage your team
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Monitor sales, check-ins, and revenue in real-time
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 px-6 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of event-goers and organizers on Ethiopia's premier
            platform
          </p>
